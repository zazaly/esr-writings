::: navheader
  ...
  -------------------------------------- --------- --------------------------------------
  [Prev](pr01s05.html){accesskey="p"}     Preface     [Next](context.html){accesskey="n"}
...
## []{#id2808316}Author\'s Acknowledgements {#authors-acknowledgements .title style="clear: both"}
...
::: footnote
^\[[3](pr01s06.html#id2808454){#ftn.id2808454}\]^ An appreciation of Alexander\'s work, with links to on-line versions of significant portions, may be found at [Some Notes on Christopher Alexander](http://www.math.utsa.edu/sphere/salingar/Chris.text.html){target="_top"}.
:::
::::
:::::::
...
------------------------------------------------------------------------
  ...
  -------------------------------------- ----------------------------------- --------------------------------------
  [Prev](pr01s05.html){accesskey="p"}     [Up](preface.html){accesskey="u"}     [Next](context.html){accesskey="n"}
  Our Case Studies                        [Home](index.html){accesskey="h"}                         Part I. Context
  -------------------------------------- ----------------------------------- --------------------------------------
:::
