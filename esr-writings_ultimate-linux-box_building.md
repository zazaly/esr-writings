::: NAVHEADER
  ...
  -------------------------------------------------------------------------------------------- -- -------------------------------------------------
  [\<\<\< Previous](recipe.html){accesskey="P"}                                                     [Next \>\>\>](horror_story.html){accesskey="N"}
...
------------------------------------------------------------------------
  ...
  ----------------------------------------------- ------------------------------------- -------------------------------------------------
  [\<\<\< Previous](recipe.html){accesskey="P"}    [Home](ulb2001.html){accesskey="H"}    [Next \>\>\>](horror_story.html){accesskey="N"}
  The Recipe File                                                                                             The Inevitable Horror Story
  ----------------------------------------------- ------------------------------------- -------------------------------------------------
:::
